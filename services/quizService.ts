...
const pathRecommendations: Record<string, PathRecommendation> = {
  "The Resilient Navigator": { pathId: 'path-1', pathLabel: 'Path 1', pathTitle: 'Clarity & Assessment', pathEmoji: '🧭', description: "You're already regulated. Start with a clarity session to map your nervous system.", whyThisPath: 'Your nervous system is well-regulated. A strategic assessment will help you identify your next direction.' },
  "The Vigilant Guardian": { pathId: 'path-2', pathLabel: 'Path 2', pathTitle: 'Somatic Healing', pathEmoji: '🌿', description: 'Your nervous system is working overtime. Time to release trapped survival energy.', whyThisPath: 'High sympathetic activation needs discharge through somatic experiencing.' },
  "The Quiet Retreater": { pathId: 'path-2', pathLabel: 'Path 2', pathTitle: 'Somatic Healing', pathEmoji: '🌿', description: 'Your nervous system has learned to withdraw. Gentle somatic work helps reconnection.', whyThisPath: "Dorsal vagal shutdown is your body's way of conserving energy. We'll expand your window of tolerance." },
  "The Sensitive Empath": { pathId: 'path-2', pathLabel: 'Path 2', pathTitle: 'Somatic Healing', pathEmoji: '🌿', description: 'You have a narrow window of tolerance. Expanding that container is the work.', whyThisPath: 'Your sensitivity needs support. We gently expand your capacity.' },
  "The Disconnected Achiever": { pathId: 'path-5', pathLabel: 'Path 5', pathTitle: 'Mentorship', pathEmoji: '👑', description: "You've mastered achievement at the cost of embodiment. Reconnecting mind and body is the work.", whyThisPath: 'Mind-body integration AND strategic design. Mentorship weaves somatic awareness with leadership.' },
  "The Isolated Seeker": { pathId: 'path-3', pathLabel: 'Path 3', pathTitle: 'Integration Support', pathEmoji: '✨', description: 'Connection feels risky. Healing the social engagement system opens the door.', whyThisPath: 'Integration work includes co-regulation practices for connection safety.' },
  "The Adaptive Survivor": { pathId: 'path-2', pathLabel: 'Path 2', pathTitle: 'Somatic Healing', pathEmoji: '🌿', description: "You've developed complex adaptations. It's time to simplify and stabilize.", whyThisPath: 'Complex patterns need graduated somatic work at the foundation.' },
  "The Awakening Healer": { pathId: 'path-2', pathLabel: 'Path 2', pathTitle: 'Somatic Healing', pathEmoji: '🌿', description: 'You recognize deep patterns need support. Nervous system healing is the foundation.', whyThisPath: 'Profound healing requires a solid nervous system foundation.' }
};
